...
public class MMS extends LetvTestCase {
	...
	/*	LeUiObject simcard = new LeUiObject(new UiSelector()
		...
		phone.click(135,363);
		sleepInt(6);
		LeUiObject sim2card = new LeUiObject(new UiSelector().resourceId("com.android.mms:id/sub_sim2_selected_layout"));
	...
	private void deleteExistingMsg() throws UiObjectNotFoundException {
		...
		del.click();
		sleepInt(1);
		LeUiObject confirm = new LeUiObject(new UiSelector().className("android.widget.Button").textContains("删除"));
