...
public class SMS extends LetvTestCase {
	...
	public void testSMSSim1() throws UiObjectNotFoundException {
		...
		.className("android.widget.FrameLayout").resourceId("com.android.mms:id/sim1View"));
	...
	/*	sleepInt(1);
		...
		LeUiObject sim2card = new LeUiObject(new UiSelector()
			.className("android.widget.FrameLayout").resourceId("com.android.mms:id/sim2View"));
